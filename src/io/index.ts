...
import { is, mergeUint8Arrays } from "../builtins/tshelpers" // Some extra typescript guards
 ...
 */
export class Buffer implements ByteReader, Reader, ReaderAt, ReaderFrom, ByteWriter, Writer, WriterAt, WriterTo {
    ...
    // Not present in Go
    get jsUnderlyingBuffer (): Uint8Array {
        return this.buf
    }
